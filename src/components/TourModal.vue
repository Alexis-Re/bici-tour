  ...
  <Teleport to="body">
    ...
    >
      ...
      >
        ...
        <div class="sticky bottom-0 bg-white border-t border-gray-100 p-4 md:p-6 rounded-b-3xl flex flex-col sm:flex-row gap-3 shrink-0">
          <a
            href="#contacto"
            class="flex-1 bg-orange-500 hover:bg-orange-600 text-white font-semibold py-3 md:py-4 rounded-xl text-center transition-all duration-300 hover:-translate-y-0.5 shadow-lg shadow-orange-500/20"
            @click="emit('close')"
          >
          ...
          <button
            type="button"
            class="flex-1 bg-gray-100 hover:bg-gray-200 text-gray-800 font-semibold py-3 md:py-4 rounded-xl transition-all duration-300"
            @click="emit('close')"
          >
            Cerrar
          </button>
